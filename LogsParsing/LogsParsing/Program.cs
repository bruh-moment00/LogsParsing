...
parser.WithParsed<CLIOptions>(opt =>
{
    ...
    {
        Console.WriteLine("Временной интервал задан в некорректном формате. Время должно быть указано в формате dd.MM.yyyy");
    }
...
internal class CLIOptions
{
    ...
    //[Option("address-mask", Required = false, HelpText = "маска подсети, задающая верхнюю границу диапазона десятичное число. Обязательно наличие параметра address-start")]
